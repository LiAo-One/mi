 ...
 */
@RestController
@RequestMapping("/perceive")
@Api(tags = {""})
public class PerceiveController {

    @Autowired
    private PerceiveService perceiveService;
    ...
    public R selPage(Perceive recode) {
        return perceiveService.selPage(recode);
    }
    ...
    public R findById(Long id){
        return perceiveService.findById(id);
    }
    ...
    public R findByIds(@RequestParam("ids") List<Long> ids){
        return perceiveService.findByIds(ids);
    }
    ...
    public R add(Perceive recode) {
        return perceiveService.add(recode);
    }
    ...
    public R upd(Perceive recode) {
        return perceiveService.updById(recode);
    }
    ...
    public R delete(Long id){
        return perceiveService.delete(id);
    }
    ...
    public R deletes(@RequestParam("ids") List<Long> ids){
        return perceiveService.deletes(ids);
    }
}
